...
function generateZiweiCharacterBio(userData, chart, attributes, sihuaType) {
    ...
    bio += `---\n\n`;
    bio += `# 九、角色语录\n\n`;
    bio += `> *以下三句台词凝练自${pronoun}的命盘特质，可直接用于剧本或小说创作*\n\n`;
    var quotes = _generateCharacterQuotes(mainStar, sihuaType, patternType, pronoun, eraRaw, name);
    quotes.forEach(function(q) { bio += '> ' + q + '\n\n'; });
 ...
 */
function _generateCharacterQuotes(mainStar, sihuaType, patternType, pronoun, era, name) {

    // 主星独白库（内心OS，不说给别人听的那种）
    var innerQuotes = {
